...
public class IIISum {
    ...
    public static List<List<Integer>> threeSum(int[] nums) {
        ...
        for(int i=0;i<tempNume.size()-1;i++){
            ...
            while(l<r){
                ...
                if(tempNume.get(l)+tempNume.get(r)==t){
                    if(r<tempNume.size()-1 && l>i+1  && tempNume.get(l)==tempNume.get(l-1) && tempNume.get(r)==tempNume.get(r+1)){
                        l++;
                        r--;
                        continue;
                    }
                ...
                }else if(tempNume.get(l)+tempNume.get(r)-t<0){
                    //左指针右移
                    l++;
                }else if(tempNume.get(l)+tempNume.get(r)-t>0){
                    //右指针左移
